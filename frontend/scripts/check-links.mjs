...
// expectName은 복지로 상세 페이지에 존재하는 핵심 토큰(짧게 — 표기 변형에 덜 취약)
const BOKJIRO = [
  ['WLF00001164', '기초연금'],
  ['WLF00001171', '아동수당'],
  ['WLF00004657', '부모급여'],
  ...
  ['WLF00004656', '첫만남이용권'],
  ['WLF00001132', '생계급여'],
  // 2026-07 확장(공공데이터 B554287 검증) — seed 정책 신청 직행
  ['WLF00003249', '장애인연금'],
  ...
  ['WLF00000072', '에너지바우처'],
  ['WLF00000078', '청소년특별지원'],
  ['WLF00000864', '희귀질환자 의료비'],
  ['WLF00006266', '청년미래적금'],
  ['WLF00000055', '통합문화이용권'],
  ['WLF00000092', '기저귀'],
  ['WLF00003192', '다문화가족 방문교육'],
  ['WLF00001099', '농업인'],
  ['WLF00003181', '장애인의료비'],
  ['WLF00000024', '아이돌봄'],
  ['WLF00006215', '청년내일채움공제'],
  ['WLF00001128', '에너지효율'],
  ['WLF00000948', '학교 밖 청소년'],
  // 2026-07-15 2차 확장(감사 워크플로 검증) — 대표 국가제도 직행
  ['WLF00001089', '교육급여'],
  ['WLF00003201', '주거급여'],
  ['WLF00003250', '보육료'],
  ['WLF00000969', '유아학비'],
