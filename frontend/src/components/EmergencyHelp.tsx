                      ...
                      {matched.map((p) => {
                        ...
                        return (
                          <li key={p.id} className="card-cute p-3">
                            ...
                            <a href={bestApplyUrl(p.application, p.name, p.id)} target="_blank" rel="noopener noreferrer" className="mt-1.5 inline-flex items-center gap-1 text-xs font-semibold text-sprout-700 hover:underline">
