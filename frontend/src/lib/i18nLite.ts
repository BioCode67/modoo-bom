...
type Key =
  ...
  | 'clerkCard' | 'clerkHint'
  | 'confirmApplyQ' | 'confirmDocQ' | 'yesDone' | 'notYet' | 'openOfficial'
...
const DICT: Record<UiLang, Record<Key, string>> = {
  ko: {
    ...
    flowTitle: '신청은 이렇게 진행돼요', stepRecommend: '맞춤 추천 완료', stepPick: '직접 고른 복지', stepInfo: '신청서 정보 준비',
    ...
    confirmApplyQ: '신청을 완료하셨나요?', confirmDocQ: '발급을 완료하셨나요?', yesDone: '네, 완료했어요', notYet: '아직이에요', openOfficial: '공식 신청 페이지 열기',
  },
  en: {
    ...
    save: 'Save', saved: 'Saved', goApply: 'Copy my info + apply on official site', issue: 'Get',
    flowTitle: 'How the application works', stepRecommend: 'Matched for you', stepPick: 'You picked this', stepInfo: 'Prepare your info',
    ...
    confirmApplyQ: 'Did you finish applying?', confirmDocQ: 'Did you get the document?', yesDone: 'Yes, done', notYet: 'Not yet', openOfficial: 'Open official apply page',
  },
  vi: {
    ...
    save: 'Lưu', saved: 'Đã lưu', goApply: 'Sao chép thông tin + đăng ký chính thức', issue: 'Cấp',
    flowTitle: 'Quy trình đăng ký', stepRecommend: 'Đã gợi ý cho bạn', stepPick: 'Bạn đã tự chọn', stepInfo: 'Chuẩn bị thông tin',
    ...
    confirmApplyQ: 'Bạn đã nộp đơn xong chưa?', confirmDocQ: 'Bạn đã nhận giấy tờ chưa?', yesDone: 'Rồi, xong rồi', notYet: 'Chưa', openOfficial: 'Mở trang đăng ký chính thức',
  },
  zh: {
    ...
    save: '收藏', saved: '已收藏', goApply: '复制我的信息 + 在官方网站申请', issue: '开具',
    flowTitle: '申请流程', stepRecommend: '已为您匹配', stepPick: '您自行选择的', stepInfo: '准备信息',
    ...
    confirmApplyQ: '您完成申请了吗？', confirmDocQ: '您领到文件了吗？', yesDone: '是，完成了', notYet: '还没有', openOfficial: '打开官方申请页面',
  },
  ja: {
    ...
    save: '保存', saved: '保存済み', goApply: '情報をコピー + 公式サイトで申請', issue: '発行',
    flowTitle: '申請の流れ', stepRecommend: 'あなたに合わせて選定', stepPick: 'ご自身で選択', stepInfo: '情報の準備',
    ...
    confirmApplyQ: '申請は完了しましたか？', confirmDocQ: '書類は発行できましたか？', yesDone: 'はい、完了しました', notYet: 'まだです', openOfficial: '公式申請ページを開く',
  },
  th: {
    ...
    save: 'บันทึก', saved: 'บันทึกแล้ว', goApply: 'คัดลอกข้อมูล + สมัครที่เว็บไซต์ทางการ', issue: 'ออกเอกสาร',
    flowTitle: 'ขั้นตอนการสมัคร', stepRecommend: 'จับคู่ให้คุณแล้ว', stepPick: 'คุณเลือกเอง', stepInfo: 'เตรียมข้อมูล',
    ...
    confirmApplyQ: 'สมัครเสร็จแล้วหรือยัง?', confirmDocQ: 'ได้รับเอกสารแล้วหรือยัง?', yesDone: 'เสร็จแล้ว', notYet: 'ยังไม่เสร็จ', openOfficial: 'เปิดหน้าสมัครทางการ',
  },
  ru: {
    ...
    save: 'Сохранить', saved: 'Сохранено', goApply: 'Скопировать данные + подать на офиц. сайте', issue: 'Получить',
    flowTitle: 'Как проходит подача', stepRecommend: 'Подобрано для вас', stepPick: 'Вы выбрали сами', stepInfo: 'Подготовьте данные',
    ...
    confirmApplyQ: 'Вы завершили подачу?', confirmDocQ: 'Вы получили документ?', yesDone: 'Да, готово', notYet: 'Ещё нет', openOfficial: 'Открыть официальную страницу',
  },
  ar: {
    ...
    save: 'حفظ', saved: 'محفوظ', goApply: 'انسخ معلوماتي + قدّم على الموقع الرسمي', issue: 'إصدار',
    flowTitle: 'كيف يتم التقديم', stepRecommend: 'تمت المطابقة لك', stepPick: 'اخترته بنفسك', stepInfo: 'جهّز معلوماتك',
    ...
    confirmApplyQ: 'هل أنهيت التقديم؟', confirmDocQ: 'هل حصلت على المستند؟', yesDone: 'نعم، تم', notYet: 'ليس بعد', openOfficial: 'افتح صفحة التقديم الرسمية',
  },
}
