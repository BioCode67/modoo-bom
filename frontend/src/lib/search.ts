...
const SYNONYM_GROUPS: string[][] = [
  ...
  // 생활어 확장 2차 — 자주 검색되지만 빠졌던 상황어(1글자·과광범위어는 오매칭 방지로 제외)
  ['육아', '보육', '어린이집', '유치원', '보육료', '아이돌봄', '돌봄교실', '방과후'],
  ['자립', '자활', '자산형성', '내일저축', '희망키움', '디딤씨앗', '통장'],
  ['문화', '여가', '문화누리', '공연', '전시', '체육', '스포츠', '관람', '여행'],
  ['결혼', '신혼', '혼인', '예비부부', '신혼부부'],
  ['북한이탈', '탈북', '새터민', '이탈주민'],
  ['범죄피해', '피해자', '스토킹', '가정폭력', '성폭력', '학대', '보호명령'],
  ['프리랜서', '특수고용', '플랫폼노동', '일용직', '비정규직', '단기근로', '특고'],
  ['재난', '재해', '수해', '이재민', '풍수해', '피해복구', '지진'],
  ['학교밖', '검정고시', '학업중단', '자퇴청소년'],
  ['보청기', '난청', '저시력', '인공와우', '점자', '수어'],
]
