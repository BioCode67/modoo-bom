...
describe('parseMonthly', () => {
  ...
  it("'= 월 최대 N원' 합계 표기를 우선 — 부분금액 과소표시 방지(장애인연금 회귀)", () => {
    expect(parseMonthly('기초급여 월 최대 349,700원 + 부가급여 9만원 = 월 최대 439,700원 (2026년 기준)')).toBe(439700)
    expect(parseMonthly('A 월 30만원 + B 월 20만원 = 월 50만원')).toBe(500000) // 만원 합계도
  })
