...
const FEATURES = [
  { icon: Globe, title: '다국어 AI 의미 검색', desc: '한국어·English·Tiếng Việt 등 어떤 언어로 물어도, AI가 뜻을 이해해 복지를 찾아드려요. 모델은 내 기기 안에서 직접 실행(서버 전송 없음).', tint: 'text-white bg-gradient-to-br from-sprout-600 to-emerald-600', badge: 'NEW' },
