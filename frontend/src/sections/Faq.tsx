...
const FAQS = [
  ...
  { q: '개인정보는 안전한가요?', a: '입력하신 정보는 외부 서버로 전송되지 않고 브라우저(내 기기)에만 저장됩니다. 분석도 기기 안에서 이뤄져요. 언제든 "나의 복지"에서 삭제할 수 있어요.' },
  { q: '분석 결과가 정확한가요?', a: '120여 개 복지 정책의 자격 기준을 바탕으로 받을 가능성이 높은 혜택을 안내해요. 다만 최종 수급 여부는 주민센터·복지로(129)에서 꼭 확인해 주세요.' },
  { q: '서류 자동발급이 진짜 되나요?', a: '정부24·건강보험공단·고용24의 실제 발급 페이지로 안내하고, 백엔드 연결 시 자동화 발급도 지원해요. 본인인증은 직접 진행하셔야 해요.' },
  { q: '어떤 복지가 포함되나요?', a: '기초연금, 부모급여, 아동수당, 청년 지원, 장애인 연금·활동지원, 실업급여, 주거·의료급여, 한부모 지원 등 120여 종을 다룹니다.' },
]
