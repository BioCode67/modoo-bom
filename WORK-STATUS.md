...
## 🧠 지능형 에이전트 고도화 (2026-07-04, 최신) — "첨 보는 사이트도 화면 읽고 발급"
...
- **매칭 골든 추가**: 고소득(중위150%) 페르소나 — 자산심사형(생계·기초연금·차상위) 강력추천 배제 고정.
- 품질: **프론트 269 + 백엔드 23** 통과, lint/tsc 0. (⚠️ 결정 계층 LLM은 GEMINI_API_KEY 있을 때 최상 —
