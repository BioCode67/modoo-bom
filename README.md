...
품질: ESLint(0) · 단위 테스트(vitest 719 + pytest 130+) · 실브라우저 E2E 5스위트(웹·데스크탑·모바일·촬영·흐름) · TypeScript · ErrorBoundary · 주요 복지 금액 2026년 공식 출처 검증
...
- **품질 게이트**(차트 4): 프론트 vitest 719 · 백엔드 pytest 130+ · 실브라우저 E2E 5스위트(웹 10여정·데스크탑 14종·모바일·촬영·흐름
