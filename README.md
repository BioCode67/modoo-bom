...
- **품질 게이트**(차트 4): 프론트 vitest 775 · 백엔드 pytest 262 · 실브라우저 E2E 12스위트(웹 10여정·데스크탑 30종·모바일·촬영·흐름·접근성 axe 0
