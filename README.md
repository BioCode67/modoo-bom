...
품질: ESLint(0) · 단위 테스트(vitest 775 + pytest 257) · 실브라우저 E2E 12스위트(웹·데스크탑·모바일·촬영·흐름·접근성) · TypeScript · ErrorBoundary · 주요 복지 금액 2026년 공식 출처 검증
...
│   └── tests/                       # pytest 257 (Mock·RPA 취소/정직성/패리티·서류함·세션·프리플라이트)
...
- **품질 게이트**(차트 4): 프론트 vitest 775 · 백엔드 pytest 257 · 실브라우저 E2E 12스위트(웹 10여정·데스크탑 30종·모바일·촬영·흐름·접근성 axe 0
