...
- **품질 게이트**(차트 4): 프론트 vitest 759 · 백엔드 pytest 243 · 실브라우저 E2E 12스위트(웹 10여정·데스크탑 24종·모바일·촬영·흐름·접근성 axe 0
...
| 🚀 원클릭 연쇄(발급→자동첨부→신청 대기, 🔑 로그인 인증 1회·일시 오류 자동 재시도) | 클릭 1번 + 인증 승인만 | `npm run e2e:desktop` (24종 회귀) |
