...
품질: ESLint(0) · 단위 테스트(vitest 564 + pytest 130) · 실브라우저 E2E 11여정 · TypeScript · ErrorBoundary · 주요 복지 금액 2026년 공식 출처 검증
...
- **품질 게이트**(차트 4): 프론트 vitest 564 · 백엔드 pytest 130 · 실브라우저 E2E 11여정(+대화온보딩·저장흐름·확장연동·라이브체크
