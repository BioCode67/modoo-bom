...
- **서류 15종**: 주민등록등본/초본·가족관계증명서·장애인증명서 + **소득금액증명·지방세 납세증명서·
  ...
  **💬→🖨 대화→발급 다리(2026-07-19)**: 챗 "등본 발급해줘"(`matchIssueIntent` — 발급 동사+지원 서류
  ...
  스모크 6.85(한마디+CTA→실발급 시작)·vitest 인텐트 4케이스 고정.
